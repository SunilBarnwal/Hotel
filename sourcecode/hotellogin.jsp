...
<body>
    ...
    try {
        ...
        String query = "SELECT * FROM hotel WHERE email = ? AND password = ?";
    ...
    %>
            <script>
                showAlert("Login successful!", "custdashboard.html");
            </script>
    <%
        } else {
    %>
            <script>
                showAlert("Invalid username or password. Please try again.", "hotellogin.html");
            </script>
    <%
        }
    } catch (Exception e) {
